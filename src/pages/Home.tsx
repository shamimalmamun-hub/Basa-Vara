          ...
          {heroVideoUrl ? (
            getYouTubeId(heroVideoUrl) ? (
              <div className="absolute inset-0 w-full h-full opacity-85 md:opacity-65 overflow-hidden pointer-events-none">
                <iframe
                  ref={iframeRef}
                  className="absolute top-1/2 left-1/2 min-w-[177.77vh] min-h-full w-[100vw] h-[56.25vw] -translate-x-1/2 -translate-y-1/2 scale-[2.5] md:scale-[1.05] sm:scale-100 border-0 pointer-events-none cursor-default"
